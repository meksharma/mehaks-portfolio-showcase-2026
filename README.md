...
1. Select a link in the table above.
2. Allow a few seconds for the prototype to load.
3. Interact with the controls directly in the browser.

These links are public and can be shared with people outside Microsoft.
